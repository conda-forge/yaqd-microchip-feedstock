About yaqd-microchip-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yaqd-microchip-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10517&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yaqd-microchip-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yaqd-microchip` can be installed with `conda`:
...
```
mamba install yaqd-microchip
```

It is possible to list all of the versions of `yaqd-microchip` available on your platform with `conda`:
...
```
mamba search yaqd-microchip --channel conda-forge
```
...
mamba repoquery search yaqd-microchip --channel conda-forge

# List packages depending on `yaqd-microchip`:
mamba repoquery whoneeds yaqd-microchip --channel conda-forge

# List dependencies of `yaqd-microchip`:
mamba repoquery depends yaqd-microchip --channel conda-forge
```
